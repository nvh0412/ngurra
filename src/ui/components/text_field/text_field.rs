...
use crate::{theme::Theme, ui::disableable::Disableable};
...
impl TextField {
    pub fn new(cx: &mut WindowContext, placeholder: String, disable: bool) -> Self {
        ...
        div()
            ...
            .on_key_down(move |event, cx| {
                ...
                self.view.update(cx, |text_view, vc| {
                    ...
                    let m = event.keystroke.modifiers.command;
